...
exec_directory = C:\Users\gabri\workpace\gessofer-rs\gessofer-qt\src
...
# python path
python_path = C:\Users\gabri\workpace\gessofer-rs\gessofer-qt\.venv\Scripts\python.exe
...
extra_args = --noinclude-qt-translations --noinclude-pytest-mode=nofollow --noinclude-unittest-mode=nofollow --windows-console-mode=disable --msvc=latest --include-data-dir=src/assets=assets
