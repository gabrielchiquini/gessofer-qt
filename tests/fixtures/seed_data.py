...
ORDERS_DATA: tuple[OrderSeed, ...] = (
    OrderSeed(
        ...
        unloading=1000,
        products=(
            ProductSeed("prod-a1", "Cimento CP-II 50kg", 1, 25000, 25000, 30882, 1),
            ProductSeed("prod-a2", "Cimento CP-II 1kg", 1, 500, 500, 618, 2),
        ),
    ),
    OrderSeed(
        id="order-b",
        ...
        unloading=500,
        products=(
            ProductSeed("prod-b1", "Areia média", 2, 120000, 240000, 121750, 1),
        ),
    ),
    OrderSeed(
        id="order-c",
        ...
        unloading=800,
        products=(
            ProductSeed("prod-c1", "Cimento CP-I 50kg", 1, 22000, 22000, 26800, 1),
        ),
    ),
    OrderSeed(
        id="order-d",
        ...
        unloading=1200,
        products=(
            ProductSeed("prod-d1", "Tijolo cerâmico 8 furos", 20, 1200, 24000, 1560, 1),
        ),
    ),
    OrderSeed(
        id="order-e",
        ...
        unloading=500,
        products=(
            ProductSeed("prod-e1", "Cal hidratada 20kg", 2, 8000, 16000, 9250, 1),
        ),
    ),
)
